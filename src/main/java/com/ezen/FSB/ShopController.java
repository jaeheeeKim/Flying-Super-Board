...
public class ShopController {
	...
	public ModelAndView mainShop(@RequestParam(defaultValue = "1") int prod_num, HttpServletRequest req, @RequestParam Map<String, String> params) {
		...
		int mem_num = 0;
	       ...
	       if((int)session.getAttribute("mem_num") !=0){
...
//			int sc_num3 = clist.get(i).getSc_num();
//			String sc_name = clist.get(i).getSc_name();
//			map2.put(sc_name, sc_num3);
//		}
//		req.setAttribute("couponList2", map2);
//		mav.setViewName("shop/shop_view");
...
//		req.setAttribute("myPageCoupon", list);
		
//		Map<Integer, Integer> map = new HashMap<>();
//		for(int i=0; i<list.size(); ++i) {
//			int sc_num2 = list.get(i).getSc_num();
//			map.put(sc_num2, list.get(i).getSc_num());
//		}
//		mav.addObject("myPageCoupon2", map);
//		System.out.println("java싫은데 sc_num2 가져왔니?" + map);
...
//		@RequestParam(value="chbox[]") List<String> chArr, @RequestParam int prod_num
//		cart_num = 0;
//		for(String i : chArr) {
//			cart_num = Integer.parseInt(i);
//			shopMapper.deleteCart(cart_num);
